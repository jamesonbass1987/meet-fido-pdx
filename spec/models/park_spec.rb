...
describe Park do
    before(:each) do
        ...
        @dog_1 = Dog.create!(name: 'Fido',  neighborhood: @neighborhood,  description: 'dog', age: @age, temperament: @temperament, size: @size, user: @user, breed: @breed, preferred_park: @park )
        @dog_2 = Dog.create!(name: 'Fido',  neighborhood: @neighborhood,  description: 'dog',age: @age, temperament: @temperament, size: @size, user: @user, breed: @breed, preferred_park: @park )
