...
describe User do
  before(:each) do
    ...
    @dog_1 = Dog.create!(name: 'Fido',  neighborhood: @neighborhood,  description: 'dog', age: @age, size: @size, user: @user, breed: @breed )
    @dog_2 = Dog.create!(name: 'Fido',  neighborhood: @neighborhood,  description: 'dog',age: @age, size: @size, user: @user, breed: @breed )
